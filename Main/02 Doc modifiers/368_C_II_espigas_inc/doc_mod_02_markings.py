...
def _update_page1(root_el: etree.Element,
    ...
    fields = {
        ...
        'Descripción del ítem de ensayo': cert_data.get('Descripcion del item de ensayo', ''),
        'Marca Registrada':               cert_data.get('Marca', ''),
        'Modelo y/o referencia tipo':     cert_data.get('Modelo', ''),
    }
    ...
    caract_value = cert_data.get('Caracteristicas tecnicas', '')
...
def _update_cert_pag(root_el: etree.Element, cert_data: dict):
    ...
    fields = {
        ...
        'Solicitud:':     cert_data.get('Solicitud de certificadora', ''),
        'Identificación:':cert_data.get('Identificacion de certificadora', ''),
    }
    for label, value in fields.items():
...
def _update_particularidades(root_el: etree.Element,
    ...
    """
    fields = {
        'Conexión a la alimentación': eut_data.get('Conexión de alimentación', ''),
        'Clase de equipo':            eut_data.get('Clase de aislación', ''),
